...
function ItemDAO(database) {
    ...
    this.getCategories = function(callback) {
        ...
        */
        ...
        var cursor = this.collection.aggregate([                        
        ...
        cursor.toArray((err,relatedItems) => {
            ...
            if (relatedItems){                
                categories = [this.getAllCategory(relatedItems.length),...relatedItems];                
                callback(categories);
            }
        }); 
    ...
    this.getAllCategory = (numOfCategories) => {
        return {_id: "All",num: numOfCategories};
    }
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
        ...
        const categoryMatch = category !== "All" ?  {"category" : category} : {};
    ...
    this.getNumItems = function(category, callback) {
        ...
        cursor.toArray((err,relatedItem) => {
            if (err) console.error(err);                        
            var numItems = 0;
            relatedItem.forEach(item => {
                numItems = numItems + item.num;
            })                   
            callback(numItems);                        
        });        
    }
    ...
    this.searchItems = function(query, page, itemsPerPage, callback) {
        ...
        var cursor = this.collection.find(queryOr);
    ...
    this.addReview = function(itemId, comment, name, stars, callback) {
        ...
        this.collection.update({_id: itemId},
